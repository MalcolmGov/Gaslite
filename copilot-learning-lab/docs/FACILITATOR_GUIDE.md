...
| 37–45 | Independent practice and discussion | Practice | Each learner picks one exercise. Core skills: meeting preparation, policy knowledge or project delivery. Or pick one of the six *Agents your teams will use* closest to their job: procedures navigator, compliance Q&A, onboarding buddy, meeting to actions, weekly status report or case triage | Debrief: Where did the tool help? Where did you have to check its work? What would you never approve without reading? Point learners to **See your results** for their personal feedback. |
