...
const nextConfig: NextConfig = {
  ...
  output: "standalone",
  // This app lives in a subfolder of the Gaslite repository (which has its own
  // lockfile). Pin the workspace root so tracing and standalone output stay
  ...
  async redirects() {
    return [
      ...
      // Book PDFs are served from the upstream prompts.chat repository
      {
