...
> Quick reference for Claude Code when working on Moove Prompts (the Moove Digital build of prompts.chat)

## Project Overview

**Moove Prompts** is the Moove Digital white-label build of [prompts.chat](https://github.com/f/prompts.chat), a social platform for AI prompts built with Next.js 16 App Router, React 19, TypeScript, and PostgreSQL/Prisma. It allows users to share, discover, and collect prompts.
