...
export function GasliteLogoSvg({ size = "md", className = "", showTagline = false }: GasliteLogoSvgProps) {
  ...
  return (
    <Link href="/" className={`flex items-center ${className}`} data-testid="gaslite-logo">
      ...
      >
        <defs>
          <linearGradient id="flameGrad" x1="0" y1="1" x2="0.5" y2="0">
            <stop offset="0%" stopColor="#0EA5E9" />
            <stop offset="50%" stopColor="#38BDF8" />
            <stop offset="100%" stopColor="#7DD3FC" />
          </linearGradient>
          <linearGradient id="flameInner" x1="0.3" y1="1" x2="0.5" y2="0">
          ...
          <linearGradient id="liteGrad" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#38BDF8" />
        ...
        <text
          ...
          letterSpacing="-1"
        >
          <tspan fill="url(#textGrad)">Gas</tspan>
          <tspan fill="url(#liteGrad)">Lite</tspan>
        </text>
