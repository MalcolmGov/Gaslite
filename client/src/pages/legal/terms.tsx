        ...
        <Card className="overflow-visible">
          <CardContent className="pt-6 prose prose-sm dark:prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <p className="text-muted-foreground">All orders are subject to availability and confirmation. Prices are displayed in South African Rand (ZAR) and include VAT where applicable. A delivery fee of R29.00 applies to all orders. Card payments incur a processing fee of 2.6% plus 15% VAT on the processing fee. Payment is processed at the time of order placement. Gaslite accepts card payments only — no cash on delivery.</p>
            </section>
